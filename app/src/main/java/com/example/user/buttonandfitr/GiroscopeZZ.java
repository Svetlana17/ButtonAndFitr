...
public class GiroscopeZZ extends   AppCompatActivity   implements SensorEventListener, View.OnClickListener {
...
//        spinner = (Spinner)findViewById(R.id.spinner);
    ...
    public void addEntry(SensorEvent event) {
        ...
        seriesZZ.appendData(new DataPoint(graph2LastZValue, z), true, 20);
...
//        graph.addSeries(series);
    ...
    protected void onDestroy() {
        mSensorManager.unregisterListener(GiroscopeZZ.this);
        thread.interrupt();
        super.onDestroy();
    }
