...
public class GiroscopeXX extends AppCompatActivity
...
public void addEntry(SensorEvent event) {
        ...
        seriesXX.appendData(new DataPoint(graph2LastXValue, x), true, 20);
...
protected void onDestroy() {
        mSensorManager.unregisterListener(GiroscopeXX.this);
        thread.interrupt();
        super.onDestroy();
        }
