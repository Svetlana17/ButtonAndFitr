...
//        spinner = (Spinner)findViewById(R.id.spinner);
        ...
        sensoGiroscope = mSensorManager.getDefaultSensor(Sensor.TYPE_GYROSCOPE);
//

        System.out.println(sensoGiroscope);
...
protected void onResume() {
        super.onResume();
        mSensorManager.registerListener(this, sensoGiroscope, SensorManager.SENSOR_DELAY_NORMAL);
        }
