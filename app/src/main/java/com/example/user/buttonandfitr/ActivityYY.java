...
public class ActivityYY extends  AppCompatActivity implements SensorEventListener, View.OnClickListener {
    private SensorManager mSensorManager;
    Sensor sensorAccelerometr;
    GraphView graph;
    private double graph2LastYValue = 5d;
    private double graph2LastYYValue = 5d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButton = (Button) findViewById(R.id.buttonYY);
    ...
    public void addEntry(SensorEvent event) {
        ...
        seriesYY.appendData(new DataPoint(graph2LastYYValue, yy), true, 20);
...
//        graph.addSeries(series);
    ...
    protected void onDestroy() {
        mSensorManager.unregisterListener(ActivityYY.this);
        thread.interrupt();
        super.onDestroy();
    }
